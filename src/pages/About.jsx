  ...
  return (
    <div className="w-screen h-fit">
      <div className="md:w-screen md:h-full" style={{backgroundImage: `url(${image})`, backgroundSize: 'cover'}}>
        ...
        <h1 className="md:text-lg font-bold text-center px-5 md:px-0   text-[#2e388d] regular  ">A Specialist Supplier and Distributor Of Board Products !!</h1>
        </div>
    </div>
    <div className="w-full md:py-5 md:px-10  h-full">
         <div className=" w-full h-full ">
         <h1 className="text-[#00abec] px-28 pt-3 md:pt-0 md:px-0 bold font-extrabold text-4xl">ABOUT US</h1>
         </div>
         <div className="w-full h-full">
          <p className="text-black  regular py-3 px-5 md:px-0 text-sm md:text-lg md:py-2 ">
          ...
          <p className="text-black py-3 regular px-5 md:px-0 text-sm md:text-lg md:py-2">
          ...
          <p className="text-black px-5 regular md:px-0 text-sm md:mb-2 md:py-2 md:text-lg">
          ...
          <div className="w-full mt-4 h-full md:flex">
              <div className="flex-col">
                ...
                <h1 className="text-[#00abec] px-[6rem] md:px-0 md:py-8 pt-3 md:pt-0 bold  font-extrabold text-4xl">OUR VISION</h1>
                <p className="text-black regular px-5 md:px-0 md:w-[80%]">
              ...
              <h1 className="text-[#00abec] px-[6rem] md:px-0 bold font-extrabold text-4xl">OUR VISION</h1>
              <p className="text-black md:py-3 px-5 md:px-0 pb-3 md:pb-0 regular  md:w-[80%]">
                  To use modern technology and a dedicated, well-motivated team in providing superior customer experience through creative designs, inspirational ideas &nd tips for kitchen cupbeards, built in cabinets &nd other home &nd office furniture.
                </p>
                <div className="">
            ...
            <div className="w-full pt-5 md:pt-0 flex justify-center md:mt-5 items-center h-full">
              <div className="w-[30%] md:py-10">
                <h1 className="bg-gradient-to-r text-center rounded-lg md:text-2xl from-[#283980] md:p-2 font-bold bold  text-white to-[#02a7e9] ">
        ...
        <div className="bg-[#bcd22f] md:flex py-3 px-10 w-full h-full">
         ...
         <h1 className="font-bold md:text-4xl bold  px-18 md:px-0 text-white">
            READY TO BEGIN YOUR
          </h1>
          <h1 className="font-bold md:text-4xl px-20 bold  md:px-0 text-white">
            JOURNEY WITH US?
          </h1>
         </div>
