  ...
  return (
    ...
    <section className="w-full md:h-screen" >
      ...
      <div className=" flex-1  md:flex md:py-8 md:rounded-3xl px-2 md:px-0   bg-gradient-to-r  from-[#283980] md:p-2 to-[#02a7e9] ">
       ...
       <h1 className="font-extrabold text-xl px-28 md:px-0 bold  text-white md:text-4xl">OUR SERVICES</h1>
       <p className="text-white text-sm md:text-2xl regular py-2 px-5 md:px-0  md:py-0">A Specialist Supplier and Distributor of Board Products!!</p>
       </div>
   ...
   <div className="w-full  px-10 md:pt-32 h-full">
      <div className="md:flex pt-5 md:pt-0 mb-3 md:mb-0">
       <div className="md:w-1/2 order-1 md:order-none">
       <img src={image} alt="" className="w-[100%]" />
       </div>
       <div className="md:px-3 md:flex-col md:py-10 md:w-1/2 order-2 md:order-none">
        <h1 className="text-black  md:text-3xl bold ">MELAMINE BOARDS</h1>
        <p className="text-black  regular md:mt-5 md:text-lg">Melamine is a organic chemical compound that can be mixed with form & idehyde to produce & thermosetting plastic. The product is called melamine resin and is used in the timber industry as a high pressure decorative laminate. It is extremely durable &nd has certain fire resistant properties. These properties make it a suitable choice for products such as laminate flooring, Formica, dry erase boards and dinnerware.</p>
       </div>
      </div>

      <div className="  md:flex">
      
       <div className="md:px-3 md:flex-col md:relative absolute mt-[15rem] md:mt-0 md:py-28">
        <h1 className="text-black bold md:text-3xl md:flex md:justify-end ">HIGH GLOSS MDF</h1>
        <p className="text-black  regular  md:mt-5 md:text-lg">This is a premium finish on chipboard or supawood, High Gloss MDF Board is suitable for use on fine quality residentail &nd contract furniture, casework and also for architectural application on inside wall, interior doors and sliding door systems.</p>
       </div>
       <div className="w-[100%]">
      ...
      <div className="md:w-1/2">
       ...
       <div className="md:px-3 md:flex-col mt-3 md:mt-0   md:py-32 md:w-1/2">
        <h1 className="text-black bold md:text-3xl ">CUTTING AND EDGING</h1>
        <p className="text-black  regular md:mt-5 md:text-lg">Cutting-edge precision, edging perfection.Trust our experienced team to deliver high-quality board cutting and edging services that exceed your expectations.</p>
       </div>
      </div>

      <div className="  md:flex">
       <div className="md:px-3 md:flex-col md:relative absolute mt-[13rem] md:mt-0 md:py-28">
        <h1 className="text-black font-bold md:text-3xl flex md:justify-end ">CABINET HARDWARE</h1>
