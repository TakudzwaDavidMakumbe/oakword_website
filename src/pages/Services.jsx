...
const Services = () => {
  return (
    ...
    <section className="w-full md:h-screen" >
      <h1 className="md:text-7xl text-4xl flex justify-center md:mt-[14rem] pt-[8rem] text-white font-bold">GOING</h1>
      ...
      <div className=" flex-1  md:flex md:py-8 md:rounded-3xl px-2 md:px-0   bg-gradient-to-r  from-[#283980] md:p-2 to-[#02a7e9] ">
       ...
       <h1 className="font-extrabold text-xl px-24 md:px-0   text-white md:text-4xl">OUR SERVICES</h1>
       <p className="text-white text-sm md:text-2xl py-2 px-5 md:px-0  md:py-0">A Specialist Supplier and Distributor of Board Products!!</p>
       </div>
   ...
   <div className="w-full  px-10 md:pt-32 h-full">
    ...
    <div className="bg-[#02a7e9] w-full  text-xs md:text-sm  flex justify-between">
