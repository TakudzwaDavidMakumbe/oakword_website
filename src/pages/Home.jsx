  ...
  return (
    <div className='w-full h-full'>
      ...
      <div className="w-full pb-3 md:pb-10 md:px-20 h-full">
        <div className="w-full md:flex justify-center h-full">
          <div className="flex-col justify-center text-center md:px-12 border-r">
            ...
            <h1 className="text-[#12b3ca] text-2xl md:text-sm bold font-bold">INTEGRITY</h1>
            <p className="text-black px-10 md:px-0 md:text-sm regular md:w-[100%] text-lg mt-1">We hold ourselves to the highest standards and behave honestly and openly</p>
          </div>
          <div className="flex-col justify-center text-center md:px-12 border-r">
            <div className="flex justify-center text-center">
              <img src={image2} alt="" className="md:w-[50%] w-[30%]" />
            </div>
            <h1 className="text-[#12b3ca] md:text-sm text-2xl bold font-bold">EXCELLENCE</h1>
            <p className="text-black md:text-sm px-10 md:px-0 regular text-lg w-[100%] mt-1">We develop high quality products to meet your precise needs.</p>
          </div>
          <div className="flex-col justify-center text-center md:px-12 border-r">
            <div className="flex justify-center text-center">
              <img src={image3} alt="" className="md:w-[50%] w-[30%]" />
            </div>
            <h1 className="text-[#12b3ca] md:text-sm text-2xl bold font-bold">INNOVATION</h1>
            <p className="text-black md:text-sm px-10 md:px-0 regular text-lg w-[100%] mt-1">We think creatively, act boldly and action our dreams into reality.</p>
          </div>
          <div className="flex-col justify-center text-center md:px-12">
            <div className="flex justify-center text-center">
              <img src={image4} alt="" className="md:w-[40%] w-[30%]" />
            </div>
            <h1 className="text-[#12b3ca] md:text-sm text-2xl bold font-bold">RESULTS</h1>
            <p className="text-black md:text-sm text-lg px-10 regular md:px-0 w-[100%] mt-1">We stand by our high quality products and commit ourselves to producing durable products.</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full md:mt-5 h-full">
        <h1 className="font-extrabold md:text-4xl pt-3 md:pt-0 text-3xl bold text-center text-[#2e388d]">TESTIMONIALS</h1>
        <h1 className="font-normal md:text-2xl text-center pb-3 md:pb-0 regular text-[#2e388d]">What Clients Say About Us</h1>
