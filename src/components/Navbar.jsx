...
const Navbar = () => {
  ...
  return (
    <nav className='relative flex justify-between border bold border-gray-300 items-center py-2 top-8 z-[100] bg-white m-5 text-black rounded-lg font-mono px-6 md:px-12 '>
      {/* Logo */}
